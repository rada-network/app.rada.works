...
const Footer = (_props) => {
  ...
  return (
    <Fragment>
      <footer
        className={`${classes[rootClassName]} py-4 px-4 lg:px-0 space-x-4 z-10 text-sm font-medium bg-white dark:bg-gray-900 border-t border-t-gray-200 dark:border-t-gray-800`}
      >
        <div className="container max-w-screen-xl mx-auto flex flex-wrap flex-col md:flex-row justify-between items-center">
